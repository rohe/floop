...
DOMAIN = '127.0.0.1'
SERVER_NAME = ':'.join([DOMAIN, str(PORT)])
...
CONFIG = {
    'server_info': {
        "issuer": "https://{}/".format(SERVER_NAME),
        ...
        'template_dir': 'templates',
        "jwks": {
            'public_path': '{}/keys/jwks.json',
            'key_defs': KEY_DEF,
            'private_path': '{}private/jwks.json'
        },
        'jwks_uri': "https://{}/keys/jwks.json".format(SERVER_NAME),
        'endpoint': {
            'webfinger': {
